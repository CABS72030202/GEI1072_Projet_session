...
char* simplify_list(Cell*, int, int);               // Function that simplifies every group in a linked list of cells and return the concatenated string corresponding to the simplified boolean equation 
