...
main: main.o public.o user.o karnaugh.o
	$(CC) $(CFLAGS) -o main main.o public.o user.o karnaugh.o $(LIB)
...
main.o: ./src/public.h ./src/public.c ./src/user.h ./src/user.c ./src/karnaugh.h ./src/karnaugh.c ./src/main.c
